function love.load()
	...
	--load graphics
	spr = {
		hexagon_blue = love.graphics.newImage('spr/hexagon_blue.png'),
		hexagon = love.graphics.newImage('spr/hexagon.png'),
		circle = love.graphics.newImage('spr/circle.png'),
		squares = love.graphics.newImage('spr/squares.png'),
		claybricks = love.graphics.newImage('spr/claybricks.png'),
		bricks = love.graphics.newImage('spr/bricks.png'),
		triangle = {
	...
	game_state = 'show_level_title'
	level_title_countdown = 60
	level_title_scroll = 0
	draining_cylinders = false
	cylinder_drain_countdown = 0
	level_up_caption = false
